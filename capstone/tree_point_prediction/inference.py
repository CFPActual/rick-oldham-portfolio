...
warnings.filterwarnings(
    "ignore",
    message=".*array interface is deprecated and will no longer work in Shapely 2.0.*",
...
# --- pandas 2.x compatibility for older geopandas ---
# Older geopandas expects pandas.Int64Index, which was removed in pandas 2.
# We alias it to the base Index type so gpd.to_file() doesn't crash.
